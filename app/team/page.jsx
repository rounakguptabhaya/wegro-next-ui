        ...
        <section className="team-two">
          <div className="auto-container">
            <div className="row clearfix">
              ...
              <div className="team-block_one col-lg-4 col-md-6 col-sm-12">
                <div className="team-block_one-inner">
                  ...
                  <div className="team-block_one-content">
                    <h4 className="team-block_one-title">
                      <a href="team-detail.html">Guy Hawkins</a>
                    </h4>
                    <div className="team-block_one-designation">Founder</div>
                    {/* Social Box */}
                    <div className="team-block_one-socials">
              ...
              <div className="team-block_one col-lg-4 col-md-6 col-sm-12">
                <div className="team-block_one-inner">
                  ...
                  <div className="team-block_one-content">
                    <h4 className="team-block_one-title">
                      <a href="team-detail.html">Albert Flores</a>
                    </h4>
                    <div className="team-block_one-designation">Founder</div>
                    {/* Social Box */}
                    <div className="team-block_one-socials">
              ...
              <div className="team-block_one col-lg-4 col-md-6 col-sm-12">
                <div className="team-block_one-inner">
                  ...
                  <div className="team-block_one-content">
                    <h4 className="team-block_one-title">
                      <a href="team-detail.html">Jacob Jones</a>
                    </h4>
                    <div className="team-block_one-designation">Founder</div>
                    {/* Social Box */}
                    <div className="team-block_one-socials">
              ...
              <div className="team-block_one col-lg-4 col-md-6 col-sm-12">
                <div className="team-block_one-inner">
                  ...
                  <div className="team-block_one-content">
                    <h4 className="team-block_one-title">
                      <a href="team-detail.html">Robert Fox</a>
                    </h4>
                    <div className="team-block_one-designation">Founder</div>
                    {/* Social Box */}
                    <div className="team-block_one-socials">
            ...
            <ul className="styled-pagination text-center">
              ...
              <li className="next">
                <a href="#">
                  <span className="fa-solid fa-angle-right fa-fw" />
                </a>
              </li>
            </ul>
